...
const dropList = document.querySelectorAll(".sel select"),
fromCurrency = document.querySelector(".from select"),
toCurrency = document.querySelector(".to select");

getButton = document.querySelector("#btn");
...
const exchangeIcon = document.querySelector(".convert .icon");
...
function getExchangeRate(){
    ...
    let url = `https://v6.exchangerate-api.com/v6/5c6fd86b759c9fa64a28bd3d/latest/${fromCurrency.value}`;
